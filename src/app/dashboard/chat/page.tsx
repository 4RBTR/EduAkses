...
export default async function ChatPage() {
  ...
  return (
    <div className="flex flex-col h-full animate-in fade-in duration-500">
      ...
      <div className="flex-1 min-h-0 h-[calc(100vh-12rem)] bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl overflow-hidden shadow-sm">
        <ChatLayout
